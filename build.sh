...
function ultibo-bash-quotation {
    ...
    then
        ...
        local DOCKER_IMAGE=markfirmware/ultibo-docker2-x64-1.3.245-rc4
...
function build-ultibo-slideshow {
    build-as QEMU src markfirmware/ultibo-slideshow/circleci-2.0
}
